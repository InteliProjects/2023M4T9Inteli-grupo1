...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg S'>Salvando Credenciais<br/>Tentando conectar o ESP na rede.<br />Se ele falhar em se reconectar ao wifi, tente novamente</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg'>O wifi não foi salvo, tente novamente!<br/></div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Conectado</strong> a {v}<br/><em><small>um IP {i}</small></em></div>";
...
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>Não conseguiu se conectar"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Sem AP estabelecido</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<td>Mostrar resultados do escaneamento do WiFi e entrar no modo de configuração do wifi.(/0wifi noscan)</td></tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td>Salvar configuração do WiFi e configurar o dispositivo. Precisa das variavéis fornecidas.</td></tr>"
 "<tr><td><a href='/param'>/param</a></td>"
 "<td>Página de parâmetros</td></tr>"
 "<tr><td><a href='/info'>/info</a></td>"
 "<td>Página de Informação</td></tr>"
 "<tr><td><a href='/u'>/u</a></td>"
 "<td>Atualização OTA</td></tr>"
 "<tr><td><a href='/close'>/close</a></td>"
 "<td>Fechar o popup do captiveportal, configportal remanecerá ativo</td></tr>"
 "<tr><td>/exit</td>"
 "<td>Sair do Config Portal, configportal fechará</td></tr>"
 "<tr><td>/restart</td>"
 "<td>Reiniciar o dispositivo</td></tr>"
 "<tr><td>/erase</td>"
 "<td>Apagar a configuração do WiFi e reiniciar o dispositivo. O dispositivo não irá reconectar a rede até a nova configuração de wifi ser enviada.</td></tr>"
 "</table>"
...
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Atualização feita com sucesso.  </strong> <br/> Dispositivo reiniciando agora...</div>";
...
// @todo remove html elements from progmem, repetetive strings
	...
	const char HTTP_INFO_chiprev[]    PROGMEM = "<dt>Chip Rev</dt><dd>{1}</dd>";
  	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Ultima vez que reiniciou</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
  	const char HTTP_INFO_aphost[]     PROGMEM = "<dt>Nome do Access Point</dt><dd>{1}</dd>";
    const char HTTP_INFO_psrsize[]    PROGMEM = "<dt>Tamanho de PSRAM</dt><dd>{1} bytes</dd>";
	const char HTTP_INFO_temp[]       PROGMEM = "<dt>Temperatura do dispositivo</dt><dd>{1} C&deg; / {2} F&deg;</dd><dt>Hall</dt><dd>{3}</dd>";
#else
	...
	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Ultima vez que reiniciou</dt><dd>{1}</dd>";
...
const char HTTP_INFO_freeheap[]   PROGMEM = "<dt>Memória - Qtd. livre do Heap</dt><dd>{1} bytes disponíveis</dd>";
...
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>Esp32</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutsdk[]     PROGMEM = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    PROGMEM = "<dt>Data da compilação</dt><dd>{1}</dd>";

const char S_brand[]              PROGMEM = "Lan de Zeppelin";
...
const char S_titlewifi[]          PROGMEM = "Configuração do ESP";
const char S_titleinfo[]          PROGMEM = "Informação";
const char S_titleparam[]         PROGMEM = "Setup";
const char S_titleparamsaved[]    PROGMEM = "Setup Salvo";
const char S_titleexit[]          PROGMEM = "Sair";
const char S_titlereset[]         PROGMEM = "Resetar";
...
const char S_resetting[]          PROGMEM = "Módulo irá resetar em alguns segundos.";
const char S_closing[]            PROGMEM = "Você pode fechar a página, o portal irá continuará ativo";
const char S_error[]              PROGMEM = "Um erro ocorreu";
